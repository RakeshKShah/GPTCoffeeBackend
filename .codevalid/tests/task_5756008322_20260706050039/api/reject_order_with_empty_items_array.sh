...
CASE_SUFFIX="$(date +%s)-$$"
EMAIL="test.user.${CASE_SUFFIX}@example.test"
PASSWORD="secret123"
RESPONSE_FILE="/tmp/reject_order_with_empty_items_array_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/reject_order_with_empty_items_array_${CASE_SUFFIX}.status"
LOGIN_FILE="/tmp/reject_order_with_empty_items_array_login_${CASE_SUFFIX}.json"
cleanup_files() {
...
echo "CODEVALID_TEST_ASSERTION_OK:reject_order_with_empty_items_array"
