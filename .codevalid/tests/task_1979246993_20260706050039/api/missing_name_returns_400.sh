...
CASE_SUFFIX="$(date +%s)-$$"
USER_EMAIL="missing-name-${CASE_SUFFIX}@example.com"
RESPONSE_FILE="/tmp/missing_name_returns_400_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/missing_name_returns_400_${CASE_SUFFIX}.status"
cleanup_files() {
...
echo "CODEVALID_TEST_ASSERTION_OK:missing_name_returns_400"
